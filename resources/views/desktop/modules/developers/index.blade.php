<div x-data="{
    ...
    endpoints: {
        auth: [
            ...
            { method: 'GET', path: '/api/user', auth: true, desc: 'Data user yang sedang login', body: '-', res: '{ id, name, email }' },
            { method: 'POST', path: '/api/logout', auth: true, desc: 'Hapus sesi token', body: '-', res: '{ message }' },
        ],
        dashboard: [
            { method: 'GET', path: '/api/dashboard/stats', auth: true, desc: 'Statistik kunjungan hari ini (IGD/Ralan/Ranap)', body: '-', res: '{ hari_ini, igd, ralan, ranap }' },
        ...
        pasien: [
            ...
            { method: 'GET', path: '/api/pasien/search-regperiksa?q=', auth: true, desc: 'Cari pasien + reg_periksa terkini', body: '-', res: '[{ no_rawat, nm_pasien, no_rkm_medis, module_key, data }]' },
        ],
        registrasi: [
        ...
        igd: [
            ...
            { method: 'GET', path: '/api/igd/dashboard', auth: true, desc: 'Dashboard IGD hari ini', body: '-', res: '{ hari_ini, ralan, ranap }' },
            ...
            { method: 'POST', path: '/api/igd/{registrasi}/tindakan', auth: true, desc: 'Tambah tindakan IGD', body: '{ tindakan, jumlah, tarif }', res: '{ message }' },
        ...
        ralan: [
            ...
            { method: 'GET', path: '/api/ralan/queue?poli=', auth: true, desc: 'Antrian Ralan hari ini per poli', body: '-', res: '[{ id, no_reg, nm_pasien, nm_poli, nm_dokter }]' },
        ...
        ranap: [
            { method: 'GET', path: '/api/ranap/dashboard', auth: true, desc: 'Dashboard Rawat Inap', body: '-', res: '{ total, rawat_inap, hari_ini_masuk, hari_ini_keluar }' },
            ...
            { method: 'POST', path: '/api/ranap/admit', auth: true, desc: 'Admisi pasien ke kamar inap', body: '{ no_rawat, kd_kamar, kd_dokter, diagnosa_awal, tgl_masuk, jam_masuk }', res: '{ message }' },
        ],
        tindakan: [
            ...
            { method: 'GET', path: '/api/igd/{no_rawat}/penanganan', auth: true, desc: 'Daftar penanganan IGD (rawat_jl_drpr)', body: '-', res: '[...]' },
            ...
            { method: 'GET', path: '/api/ranap/{no_rawat}/penanganan', auth: true, desc: 'Daftar penanganan Ranap (rawat_inap_drpr)', body: '-', res: '[...]' },
            ...
            { method: 'POST', path: '/api/tindakan/soap/{no_rawat}', auth: true, desc: 'Simpan SOAP (IGD/Ralan) ke pemeriksaan_ralan', body: '{ keluhan, pemeriksaan, penilaian, instruksi, tensi, nadi, suhu }', res: '{ message }' },
            { method: 'GET', path: '/api/ranap/soap-list/{no_rawat}', auth: true, desc: 'Riwayat SOAP per rawat (Ranap)', body: '-', res: '[...]' },
            { method: 'POST', path: '/api/ranap/soap/{no_rawat}', auth: true, desc: 'Simpan SOAP (Ranap) ke rawat_inap_drpr', body: '{ keluhan, pemeriksaan, penilaian, instruksi, tensi, nadi, suhu }', res: '{ message }' },
        ...
        settings: [
            { method: 'GET', path: '/api/identitas', auth: true, desc: 'Ambil data identitas faskes (setting)', body: '-', res: '{ nama_instansi, alamat_instansi, kabupaten, propinsi, kontak, email }' },
